    ...
    <div class="k-filter-container">
      ...
      <v-menu v-model="showDropdown" offset-y :close-on-content-click="false">
        ...
        <text-filter-options
          ...
          @set-sort-dir="setSortDir"
          @set-filter-operator="setFilterOperator"
          @set-empty-filter="setEmptyFilter"
        ...
        <boolean-filter-options
          v-else-if="isBoolean"
          ref="filter-options"
          @remove-boolean-filter="removeBooleanFilter"
          @set-boolean-filter="setBooleanFilter"
          @set-sort-dir="setSortDir"
        >
          <v-btn
                      text
        ...
        <date-filter-options
          ...
          @remove-empty-filter="removeEmptyFilter"
          @set-between="setBetween"
          @add-date-filter="addDateFilter"
          @change-date-filter="changeDateFilter"
          @remove-date-filter="removeDateFilter"
        >
          <v-btn
                      text
